...
class GFWeather:
    ...
    def start_today_info(self, is_test=False):
        ...
        for girlfriend in self.girlfriend_list:
            ...
            today_msg = self.get_weather_info(dictum_msg, city_name=city_name, city_code=city_code, start_date=start_date,
    ...
    def get_weather_info(self, dictum_msg='', city_name='海淀区', city_code='101030100', start_date='2019-06-06',
